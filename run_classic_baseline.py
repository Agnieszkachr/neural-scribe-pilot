...
Computes a classic stylometry baseline using PCA on Top 100 Most Frequent Words (Z-score normalised),
for visualization and authorship analysis.
"""
...
def main():
    ...
    # Build results
    results = {
        'methodology': "PCA on MFW z-scores (100 MFW)",
        'n_mfw': 100,
        'variance_explained': {
